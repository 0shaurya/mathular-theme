...
plt.plot(x, sin, color="red", label="sin(x)")
plt.plot(x, cos, color="purple", label="cos(x)")

plt.plot(eval("x" + str(1)), eval(str("sec") + str(1)), color="pink", label="tan(x)")
for i in range(2, 9):
 	plt.plot(eval("x" + str(i)), eval(str("tan") + str(i)), color="pink")
