...
for (let i = 0; i < algebraSelection.length; i++) {
	algebraSelection[i].addEventListener("click", function () {
		switch(i){
			...
			case 3:
				document.querySelector("#navAlgebra :nth-child(4)").style.color = "blue"; break;
			case 4:
				document.querySelector("#navAlgebra :nth-child(5)").style.color = "blue"; break;
			case 5:
				document.querySelector("#navAlgebra :nth-child(6)").style.color = "blue"; break;
			case 6:
				document.querySelector("#navAlgebra :nth-child(7)").style.color = "blue"; break;
			case 7:
				document.querySelector("#navAlgebra :nth-child(8)").style.color = "blue"; break;
			case 8:
				document.querySelector("#navAlgebra :nth-child(9)").style.color = "blue"; break;
			default:
				;
		}
	})
